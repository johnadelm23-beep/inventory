...
A Flutter-based Inventory Management System with Firebase integration.  
Supports authentication, product management, user roles (Admin/User), and real-time updates.
